...
class AudioGen:
    ...
    def generate(self, descriptions: tp.List[str], progress: bool = False, return_latent: bool = False) -> torch.Tensor:
        ...
        return self._generate_tokens(attributes, prompt_tokens, progress, return_latent)
    ...
    def _generate_tokens(self, attributes: tp.List[ConditioningAttributes],
                         prompt_tokens: tp.Optional[torch.Tensor], progress: bool = False, return_latent: bool = False) -> torch.Tensor:
        ...
        with torch.no_grad():
            ...
            if return_latent:
                return gen_audio, self.compression_model.decode_latent(gen_tokens)
        return gen_audio
