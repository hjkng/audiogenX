...
class MusicGen:
    ...
    def generate(self, descriptions: tp.List[str], progress: bool = False, return_tokens: bool = False, return_latent: bool = False) \
        ...
        if return_tokens:
            return self.generate_audio(tokens), tokens
        if return_latent:
            return self.generate_audio(tokens), self.compression_model.decode_latent(tokens)
        return self.generate_audio(tokens)
